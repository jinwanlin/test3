...
class Product < ActiveRecord::Base
  ...
  attr_accessible :des, :name, :series, :cost, :sn, :aliases, :amounts, :classify, :no, :type, :state, :unit, :market_sort, :market_area, :order_total, :order_detail, :order_spid, :market_area, :market_sort, :pinyin, :optional_amounts, :experience, :save_time, :price_1, :price_2, :price_3, :float_amount, :price_cq, :inventory, :need_stock, :order_unit, :order_times
  ...
  #普通菜
  AMOUNTS2 = [0, 1, 2, 3, 4, 5, 6, 7, 10, 12, 15, 20, 25, 30]
  #大个菜：冬瓜、南瓜
  AMOUNTS3 = [0, 5, 10, 15, 20, 25, 30, 35, 40, 50, 60]
